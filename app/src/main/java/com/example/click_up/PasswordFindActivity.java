...
//            et_emailInput.setText(auth.getCurrentUser().getEmail());
        ...
        void send_email() {
            AlertDialog.Builder ad = new AlertDialog.Builder(com.example.click_up.PasswordFindActivity.this);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(com.example.click_up.PasswordFindActivity.this,
